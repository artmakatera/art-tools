...
**Decision.** Three scopes resolving `date → weekday → global`:
...
**Rejected.** Seasonal `customWeeks` (date-ranged rule sets; deferred as no
...
the usual 8:00–12:00/13:00–17:00 default. Rationale: `calendar={{ days: { 0: false, 6: false } }}`
