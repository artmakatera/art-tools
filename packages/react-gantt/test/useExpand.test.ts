...
const tasks: GanttTask[] = [
  { id: '1', name: 'Parent', startDate: new Date('2026-01-01'), endDate: new Date('2026-01-31') },
  { id: '2', name: 'Child', parentId: '1', startDate: new Date('2026-01-02'), endDate: new Date('2026-01-10') },
  { id: '3', name: 'Grandchild', parentId: '2', startDate: new Date('2026-01-03'), endDate: new Date('2026-01-08') },
];
