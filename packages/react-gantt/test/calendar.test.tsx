...
import { Gantt, type GanttCalendar, type GanttTask } from '../src';
...
describe('working-time calendar', () => {
  ...
  it('accepts an inline calendar object without breaking rendering', () => {
    ...
    rerender(<Gantt tasks={tasks} height={300} colWidth={40} calendar={{ days: { 0: false, 6: false } }} />);
  ...
  describe('non-working shading', () => {
    ...
    it('does not shade a short working day at day scale', () => {
      ...
      const at = shadingFor({ hours: ['8:00-17:00'], days: { 5: ['8:00-12:00'], 0: false, 6: false } });
