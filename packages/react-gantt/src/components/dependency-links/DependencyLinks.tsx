    ...
    <Layer {...layerProps}>
      {links.map((link) => {
        ...
        const arrowProps = mergeSlotProps(
          {
            className: `${head.className} ${isSelected ? styles.arrowSelected : ""} ${isCritical ? styles.arrowCritical : ""}`,
            style: head.style,
          },
          slotProps?.arrow,
          linkOwnerState,
          ...
          <Fragment key={link.id}>
            ...
            {segs.map(([a, b], index) => {
              const segmentProps = mergeSlotProps(
                {
                  className: `${styles.segment} ${isSelected ? styles.segmentSelected : ""} ${isCritical ? styles.segmentCritical : ""}`,
